...
public class ClientsController {
    ...
    public String showEditForm(@RequestParam(value = "client", required = false) String clientId,
                               Model model) {
    ...
    public String editClient(@ModelAttribute BaseClientDetails clientDetails,
                             @RequestParam(value = "newClient",
                                           required = false) String newClient) {
    ...
    public String deleteClient(@ModelAttribute BaseClientDetails ClientDetails,
        ...
        clientsDetailsService
                .removeClientDetails(clientsDetailsService.loadClientByClientId(id).toString());
        return "redirect:/";
    }
}
